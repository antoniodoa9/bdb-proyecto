...
\bigskip
\noindent\bfseries{\large{Keywords:}} MySQL, InnoDB, ARCHIVE, MEMORY, GDPR, pseudonymisation, longitudinal medical records, query benchmarking, indexing, XML, XQuery, eXist-db, MongoDB, BSON, aggregation pipeline, clinical decision support, Python.
