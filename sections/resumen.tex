...
\bigskip
\noindent\bfseries{\large{Palabras clave:}} MySQL, InnoDB, ARCHIVE, MEMORY, RGPD, seudonimización, historiales médicos longitudinales, benchmarking de consultas, indexación, XML, XQuery, eXist-db, MongoDB, BSON, aggregation pipeline, soporte a la decisión clínica, Python.
