...
\begin{enumerate}
    ...
    \item \textbf{Construir una arquitectura híbrida con MongoDB que aplique guías clínicas a los pacientes y exponerla en una interfaz gráfica.} El objetivo es demostrar que MySQL (transaccional) y MongoDB (documental) pueden convivir, modelar el conocimiento clínico como documentos BSON, cruzarlo con los pacientes mediante \textit{aggregation pipelines} y rematar el sistema con una aplicación de escritorio que actúe como sistema de soporte a la decisión clínica.
...
\begin{description}
    ...
    \item[MongoDB y Compass] Base de datos documental NoSQL y su interfaz gráfica oficial. Soportan la Parte~III: almacenan las guías clínicas y los expedientes en formato BSON, ejecutan los \textit{aggregation pipelines} y permiten analizar los planes de ejecución con \textit{Explain Plan}.
...
La \textbf{Parte~III} (Sección~4) presenta la arquitectura híbrida con MongoDB. Justifica la convivencia de lo relacional y lo documental, el enfoque de privacidad desde el diseño en la carga masiva de datos, el modelado de las guías clínicas en BSON, el análisis de rendimiento con índices y, por último, la interfaz gráfica que integra todo el sistema.
