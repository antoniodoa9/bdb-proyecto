...
La \textbf{Parte~III} (Sección~5) presenta la arquitectura híbrida con MongoDB. Justifica la convivencia de lo relacional y lo documental, el enfoque de privacidad desde el diseño en la carga masiva de datos, el modelado de las guías clínicas en BSON, el análisis de rendimiento con índices y, por último, la interfaz gráfica que integra todo el sistema.
